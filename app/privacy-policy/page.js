		...
		<main className={styles.page}>
			<div className={styles.header}>
				<div className={styles.container}>
					<p className={styles.title}>Privacy Policy for Elton Jenkins Law, PLLC</p>
				</div>
			</div>
			<div className={styles.translationsContentContainer}>
				<div className={styles.container}>
					<div className={`${styles.tabContent} ${styles.translationsContentItem} ${styles.en} ${styles.visible}`} id="en">
						...
						<ul>
							...
							<li>
								<p>
									...
									&quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Elton Jenkins
									Law, PLLC, 124 East Main Street, Norman, OK 73069.
								</p>
							</li>
							<li>
								<p>
							...
							<li>
								<p>
									<strong>Website</strong> refers to Elton Jenkins Law, PLLC,
									accessible from
									<a
										href="https://www.eltonjenkinslaw.com/"
										rel="external nofollow noopener"
										target="_blank"
									>
										https://www.eltonjenkinslaw.com
									</a>
								</p>
							</li>
							<li>
						...
						<ul>
							<li>
								<p>By email: preston@eltonjenkinslaw.com</p>
							</li>
							<li>
								<p>By phone number: 4052173623</p>
							</li>
						</ul>
					</div>
				</div>
