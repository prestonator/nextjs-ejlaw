...
export default function Component() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-montserrat">
      ...
      <animated.footer style={fadeIn} className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">Elton Jenkins Law, P.L.L.C.</h3>
              <p>Compassionate legal support for families in Norman, OK and surrounding areas.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>124 E Main Street, Norman, OK 73069</p>
              <p>Phone: (405) 217-3623</p>
              <p>Email: info@eltonjenkinslaw.com</p>
            </div>
          </div>
          <div className="mt-8 text-center">
            <p>&copy; {new Date().getFullYear()} Elton Jenkins Law, P.L.L.C. All rights reserved.</p>
          </div>
        </div>
      </animated.footer>
    </div>
