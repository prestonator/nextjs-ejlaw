...
const navigationMenuTriggerStyle = cva(
	"group w-max items-center justify-center rounded-md bg-background px-4 py-2 font-medium transition-colors"
);
...
const NavigationMenuContent = React.forwardRef(
	({ className, ...props }, ref) => (
		<NavigationMenuPrimitive.Content
			ref={ref}
			className={cn(
				"left-[50%] -translate-x-1/2 translate-y-4 absolute",
